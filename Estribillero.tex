...
%  \SBRef{No puedo parar de alabarte}{2006}%fuente \#
    ...
    {} %\NotCCLIed
        ...
        \begin{SBOpGroup}
            En el cielo y en la tierra te alabamos OH Se\Ch{G}{ñor}.

            Eres \Ch{G}{dig}no de alabanza y de suprema adoración.

            Te proclamamos Señor. Te proclamamos Se\Ch{G}{ñor}.
        \end{SBOpGroup}

        \begin{SBChorus}
            Ale\Ch{G}{lu}ya, Alelu\Ch{Em7}{ya}, Ale\Ch{C2}{lu}ya \Ch{Am7}{al} Se\Ch{Dsus4}{ñor}.
            Ale\Ch{G}{lu}ya, Alelu\Ch{G}{ya}, Aleluya al Se\Ch{G}{ñor}.
        \end{SBChorus}

        \begin{SBOpGroup}
            \Ch{G}{En} la cruz por mí te diste para darme liber\Ch{G}{tad}.

            De la tumba resurgiste y en tu trono ahora es\Ch{G}{tás}.

            OH Jesús te proclamamos Señor.te proclamamos Señor
        \end{SBOpGroup}
