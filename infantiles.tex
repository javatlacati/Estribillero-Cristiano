...
%%%
    ...
    \begin{song}{Dios hizo los animales}{C}
    {\SBPubDom} %copyright \SBPubDom
    {}
    {} %pasaje
    {} %\NotCCLIed
        \ifChordBk
        \paragraph{\mbox{}\hfill\protect\href{https://open.spotify.com/intl-es/track/2WUS8sB0YXFtCFYAWoeT1T}{Escuchar}\mbox{}\hfill}
        \fi

        \begin{SBOpGroup}
            \Ch{C}{Dios} hizo los animales, diferentes los hizo \Ch{G7}{Dios}

            y aunque no son iguales, todos alaban a \Ch{C}{Dios}
        \end{SBOpGroup}

        \begin{SBChorus}
            El \Ch{C7}{sa}pito brinca \Ch{F}{así}, el mico se rasca \Ch{C}{así}

            el cangrejo camina de \Ch{G7}{la}do y el pingüino corre \Ch{C}{así}

            hay \Ch{C7}{u}no que hace \Ch{F}{guau} y el otro cocoro\Ch{C}{có}

            hay uno que hace \Ch{G7}{miau} y el otro hace cro \Ch{C}{cro}
        \end{SBChorus}
...
%  \SBRef{No puedo parar de alabarte}{2006}%fuente \#
        ...
        \begin{SBOpGroup}
            Za\Ch{E}{queo} era un chaparrito así

            Que vivía en Jeri\Ch{B7}{có}

            Y \Ch{A}{cuan}do Jesús pasó por a\Ch{B7}{llí}

            A un sicomoro su\Ch{E}{bió}
        \end{SBOpGroup}

        \begin{SBChorus}
            El Salvador le vio allí

            Y le hablo a\Ch{B7}{sí}

            Zaqueo, bájate de allí

            Porque a tu casa voy a \Ch{E}{ir}

            A tu casa voy a \Ch{E}{ir}
        \end{SBChorus}
